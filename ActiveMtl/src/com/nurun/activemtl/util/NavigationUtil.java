...
public class NavigationUtil {
    ...
    public static void goToFormFragment(FragmentActivity activity, FragmentManager fragmentManager, EventType eventType) {
        if (PreferenceHelper.isLoggedIn(activity)) {
            if (eventType == EventType.Alert) {
                ...
                goToFragment(fragmentManager, R.id.suggestion_frame, SuggestionFragment.newFragment());
            } else {
    ...
    public static void goToFragment(FragmentManager fragmentManager, int frameId, Fragment fragment, EventType eventType) {
    ...
    public static void handleMenuClick(FragmentActivity activity, int position) {
        ...
        if (position == 4) {
            ...
            Fragment fragment = getFragment(position, PreferenceHelper.isLoggedIn(activity));
            goToFragment(fragmentManager, R.id.content_frame, fragment);
        }
    }

    private static void goToFragment(FragmentManager fragmentManager, int contentFrame, Fragment newFragment) {
