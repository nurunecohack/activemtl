...
public class LoginActivity extends FragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mPlusClient = new PlusClient.Builder(this, connectionCallback,
				connectionFailListener).setVisibleActivities(
	...
	public void onActivityResult(int requestCode, int responseCode,
		...
		if (requestCode == REQUEST_CODE_RESOLVE_ERR
				&& responseCode == FragmentActivity.RESULT_OK) {
	...
	private class SessionStatusCallback implements Session.StatusCallback {
		...
		public void call(Session session, SessionState state,
			...
			PreferenceHelper.setSocialMediaConnection(LoginActivity.this,
					SocialMediaConnection.Facebook);
			...
			Request.newMeRequest(session, new Request.GraphUserCallback() {
				...
				public void onCompleted(GraphUser user, Response response) {
					if (user != null) {
						PreferenceHelper.setUserId(LoginActivity.this,
								user.getId());
						PreferenceHelper.setUserName(LoginActivity.this,
								user.getName());
						PreferenceHelper.setProfilePictureUrl(
								LoginActivity.this,
								ActiveMtlConfiguration.getInstance(
										LoginActivity.this)
										.getFacebookProfilePictureUrl(
												LoginActivity.this));
						goToNextScreen();
					}
	...
	private ConnectionCallbacks connectionCallback = new ConnectionCallbacks() {
		...
		public void onConnected(Bundle arg0) {
			...
			PreferenceHelper.setSocialMediaConnection(LoginActivity.this,
					SocialMediaConnection.Google_plus);
			PreferenceHelper.setUserId(LoginActivity.this,
					currentPerson.getId());
			PreferenceHelper.setUserName(LoginActivity.this,
					currentPerson.getDisplayName());
			PreferenceHelper.setProfilePictureUrl(LoginActivity.this,
					ActiveMtlConfiguration.getInstance(LoginActivity.this)
							.getGooleProfilePictureUrl(LoginActivity.this));
			goToNextScreen();
		}
	};
